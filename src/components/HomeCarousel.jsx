...
export default function HomeCarousel() {
  ...
  <button className="bg-yellow-500 hover:bg-yellow-600 text-black font-bold text-sm sm:text-base md:text-xl px-4 sm:px-6 md:px-10 py-2 sm:py-3 md:py-5 rounded-full shadow-xl transition-all duration-300 hover:scale-105 active:scale-95">
