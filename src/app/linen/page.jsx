...
export default function LinenPage() {
  ...
  useEffect(() => {
    const fetchCategory = async () => {
      try {
        const res = await fetch('/api/getproducts/linen?available=true')
        ...
        setError('Failed to fetch linen')
      } finally {
        setLoading(false)
      }
    }
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-[#1f1f1f] to-[#121212] overflow-hidden">
      ...
      <div className="relative z-10 text-center mt-24">
        ...
        <p className="mt-2 text-gray-400">Elegance that turns heads</p>
      </div>

      {/* Status Messages - identical to home */}
      <div className="relative z-10 mt-10 px-6 text-center">
        {loading && <p className="text-gray-500">Loading dresses...</p>}
